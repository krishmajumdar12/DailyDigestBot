...
def get_weather_emoji(icon, conditions):
    # Get weather emoji based on icon or conditions
    weather_emojis = {
        "clear-day": "☀️",
        "clear-night": "🌙",
        "rain": "🌧️",
...
def format_html_email(weather, news, stocks, quote, calendar):
    ...
    if "error" not in weather:
        weather_emoji = get_weather_emoji(weather.get("icon", ""), weather.get("conditions", ""))
        html += f"""
            <div class="section">
